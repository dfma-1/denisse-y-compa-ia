//maria fernanda cisneros sanchez
//proyecto
...
void registrarDatos(Paciente *paciente) {
    ...
    printf("Datos registrados con éxito.\n\n");
}
...
void relacionarCuarto(Paciente *paciente, Cuarto *cuarto) {
    ...
    printf("El paciente ha sido relacionado con el cuarto número %d.\n\n", cuarto->numero);
}
        ...
        switch (opcion) {
            case 1:
                if (numPacientes < MAX_PACIENTES) {
                    ...
                    printf("¡Error! Se ha alcanzado el máximo número de pacientes.\n\n");
                }
                break;
            case 2:
                if (numPacientes > 0) {
                    ...
                    if (pacienteSeleccionado >= 1 && pacienteSeleccionado <= numPacientes) {
                        ...
                        printf("¡Error! Selección de paciente inválida.\n\n");
                    }
                } else {
                ...
                if (numPacientes > 0) {
                    ...
                    if (pacienteSeleccionado >= 1 && pacienteSeleccionado <= numPacientes) {
                        ...
                        if (numMedicamentos > 0) {
                            ...
                            printf("¡Error! Número de medicamentos inválido.\n\n");
                        }
                    } else {
                        printf("¡Error! Selección de paciente inválida.\n\n");
                    }
